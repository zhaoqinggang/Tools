...
if __name__ == '__main__':
   ...
   #===============预处理模型和数据================================================================
    ...
    # 初始化模型和tokenizer
    model = SimCSE(tokenizer_name_path)
    ...
    train_path = '../../../data/raw/zuche/raw/train/train.csv'
    dev_path = '../../../data/raw/zuche/raw/dev/dev.csv'
    test_path = '../../../data/raw/zuche/raw/test/test.csv'
